				...
				<!-- <div class="top_nav_right">
					<div class="shoecart shoecart2 cart cart box_1">
						<form action="#" method="post" class="last">
							...
							<a class="top_shoe_cart" href="cart.php">
	...
	<div class="ads-grid_shop">
		<div class="shop_inner_inf">
				...
				<div class="range">
					...
					<ul class="dropdown-menu6">
						<li>
							...
							<input type="text" id="quantity" style="border: 0; color: #ffffff; font-weight: normal;" />
						</li>
					</ul>
				</div>
				<!-- //price range -->
			...
			<div class="left-ads-display col-md-9">
				...
				<div class="codephp" style="position: absolute; height: 230px; width: 1400px; background-color: black;">
					<div style="position: fixed; top: 5px; right: 5px;" class="top_nav_right">
						<div class="shoecart shoecart2 cart cart box_1">
							<form action="#" method="post" class="last">
								<input type="hidden" name="cmd" value="_cart">
								<input type="hidden" name="display" value="1">
					...
					<a style="position: fixed; top: 15px; right: 80px;" href="login.php"><img height="25px" src="./images/login.png" alt="">
						<?php
						if (isset($_COOKIE['user']) && isset($_COOKIE['password'])) {
							if ($_COOKIE['user'] == 'admin' && $_COOKIE['password'] == '123') {
								echo "Chào " . $_COOKIE['user'];
							} /* else echo '<a href="login.php" style="font-family: roboto; font-size: 13px; position: fixed; top: 18px; right: 110px; color: red">Đăng nhập</a>
									 <a href="" style="font-family: roboto; font-size: 13px; position: fixed; top: 18px; right: 27px; color: red">Đăng ký</a>'; */
						} /* else echo '<a href="login.php" style="font-family: roboto; font-size: 13px; position: fixed; top: 18px; right: 110px; color: red">Đăng nhập</a>
						         <a href="" style="font-family: roboto; font-size: 13px; position: fixed; top: 18px; right: 27px; color: red">Đăng ký</a>'; */
						?>
					</a>
